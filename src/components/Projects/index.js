  ...
  return (
    ...
    >
        ...
        <div className="projects-rocketseat_content">
          ...
          {activeIndex === 2 && (
            <div className="rocketseat_content_text fade-in-image">
              ...
              <p className="rocketseat_content_text_p">
                Do figma ao React. Aqui criei todo o guia de estilo no Figma, em
                seguida, criei o projeto React com Vite, Configurei o
                tailwindcss, Configurei o storybook, Instalei a biblioteca Radix
                UI, Utilizei o patterns do React E finalmente o Deploy da
                documentação do storybook pro Github Pages:{" "}
                <a
                  href="https://arakaki-code.github.io/ignite-lab-design-system/?path=/story/components-button--default"
                  target={"blank"}
                >
                  arakaki-code.github.io
                </a>
              </p>

              <a
                href="https://github.com/Arakaki-code/ignite-lab-design-system"
                className="rocketseat_content_github"
                target={"blank"}
              >
                <svg
      ...
      <section className="projects-alura">
        <h3 className="projects-alura-h3">Alura</h3>
        <p className="projects-alura-p">
          <a
            className="projects-alura-link"
        ...
        <div className="alura-certificate">
          ...
          <div className="certificate_content">
            <div className="certificate_content_div">
              <CardCertificate
                isDark={isDark}
